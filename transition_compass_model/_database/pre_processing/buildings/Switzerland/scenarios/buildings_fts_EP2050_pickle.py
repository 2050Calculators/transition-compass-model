...
def run(DM_buildings, lev=4):
    ...
    dm_heating_cat_fts_2.array[
        idx["Vaud"], 1 : idx[2050], idx["bld_heating-mix"], :, :, :
    ] = np.nan
    ...
    dm_heating_cat_fts_2.array[
        idx["Vaud"], idx[2050], idx["bld_heating-mix"], :, :, idx["gas"]
    ] = 0.058
    # Wood (EP2050)
    dm_heating_cat_fts_2.array[
        idx["Vaud"], idx[2050], idx["bld_heating-mix"], :, :, idx["wood"]
    ] = 0.028
