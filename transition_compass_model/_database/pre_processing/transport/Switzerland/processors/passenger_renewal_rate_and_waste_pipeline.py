...
def run(dm_private_fleet, dm_public_fleet):
    ...
    dm_new_private_fleet = dm_private_fleet.filter({"Variables": [var_names["new"]]})
    dm_renewal_rate = dm_private_fleet.filter(
        {"Variables": [var_names["renewal-rate"]]}
    )
    dm_waste_private = dm_private_fleet.filter({"Variables": [var_names["waste"]]})
    dm_private_fleet = dm_private_fleet.filter({"Variables": [var_names["stock"]]})
    ...
    DM = {
        "passenger_private-fleet": dm_private_fleet,
