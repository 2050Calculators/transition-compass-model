...
def compute_passenger_new_fleet(table_id_new_veh, file_new_veh_ots1, file_new_veh_ots2):
    ...
    def compute_new_fleet_tech_all_ots(
        dm_new_fleet_tech_ots1, dm_pass_new_fleet_ots2, first_year
    ):
    ...
    dm_new_fleet_tech = compute_new_fleet_tech_all_ots(
        dm_pass_new_fleet_tech_ots1, dm_pass_new_fleet_ots2, first_year
    )
...
def get_public_transport_data(file_url, local_filename, years_ots):
    ...
    dm_public_fleet = get_data.extract_public_passenger_fleet(
