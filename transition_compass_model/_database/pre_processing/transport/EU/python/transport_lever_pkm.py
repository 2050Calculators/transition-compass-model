...
dm_pkmtot_level4.array[idx["EU27"], idx[2050], :] = dm_pkmtot_level4.array[
    idx["EU27"], idx[2023], :
] * (1 - 0.14)
...
for v in variabs:
    dm_pkmtot_level2.array[idx["EU27"], idx[2050], idx[v]] = df_temp.loc[
        df_temp["level"] == 2, v
    ]
...
for v in variabs:
    dm_pkmtot_level3.array[idx["EU27"], idx[2050], idx[v]] = df_temp.loc[
        df_temp["level"] == 3, v
    ]
