...
waste_categories = [
    ...
    "W15010401",
    "W150107",
]  # Paper and cardboard packaging, Plastic packaging, Aluminium packaging, Glass packaging
...
waste_management = [
    ...
    "RCY",
    "RCY_NEU",
]  # Waste generated, Recovery, Recovery - energy recovery from packaging waste, Recycling, Recycling outside the EU
...
df_pac["geo\\TIME_PERIOD"] = df_pac["geo\\TIME_PERIOD"].apply(
    lambda x: (
