...
filepath = os.path.join(
    current_file_directory, "../../eu/data/datamatrix/lever_waste-management.pickle"
)
...
dm_layer2.operation(
    "energy-recovery", "/", "waste-collected", "Variables", "energy-recovery-share", "%"
)
...
dm_eu.append(
    DM_eu["fts"][1].filter({"Country": ["EU27"], "Variables": ["trains"]}), "Years"
)
...
dm_eu.append(
    DM_eu["fts"][1].filter({"Country": ["EU27"], "Variables": ["planes"]}), "Years"
)
dm_eu.rename_col("EU27", "Switzerland", "Country")
dm_waste.append(dm_eu, "Variables")
...
dm_eu.append(
    DM_eu["fts"][1].filter({"Country": ["EU27"], "Variables": ["ships"]}), "Years"
)
dm_eu.rename_col("EU27", "Switzerland", "Country")
dm_eu[..., "export"] = 1
variabs = [
...
dm_bld = extract_waste_data_from_dechets_speciaux(
    "Déchets de chantier non triés problématiques", "floor-area-new-residential"
)
...
dm_roads = extract_waste_data_from_dechets_speciaux(
    "Matériaux bitumineux de démolition des routes >", "road"
)
...
dm_eu.append(
    DM_eu["fts"][1].filter({"Country": ["EU27"], "Variables": ["road"]}), "Years"
)
dm_eu.rename_col("EU27", "Switzerland", "Country")
dm_waste.append(dm_eu, "Variables")
...
dm_eu.append(
    DM_eu["fts"][1].filter({"Country": ["EU27"], "Variables": ["rail"]}), "Years"
)
dm_eu.rename_col("EU27", "Switzerland", "Country")
dm_waste.append(dm_eu, "Variables")
...
dm_eu.append(
    DM_eu["fts"][1].filter({"Country": ["EU27"], "Variables": ["trolley-cables"]}),
    "Years",
)
dm_eu.rename_col("EU27", "Switzerland", "Country")
dm_waste.append(dm_eu, "Variables")
...
dm_eu.append(
    DM_eu["fts"][1].filter({"Country": ["EU27"], "Variables": ["electronics"]}), "Years"
)
dm_eu.rename_col("EU27", "Switzerland", "Country")
df_temp = dm_eu.filter(
...
dm_eu.append(
    DM_eu["fts"][1].filter({"Country": ["EU27"], "Variables": ["domapp"]}), "Years"
)
dm_eu.rename_col("EU27", "Switzerland", "Country")
df_temp = dm_eu.filter(
    {"Categories1": ["waste-collected", "waste-uncollected", "export", "littered"]}
...
dm.append(
    DM_eu["fts"][1].filter({"Country": ["EU27"], "Variables": ["glass-pack"]}), "Years"
)
...
dm.append(
    DM_eu["fts"][1].filter({"Country": ["EU27"], "Variables": ["plastic-pack"]}),
    "Years",
)
dm.rename_col("EU27", "Switzerland", "Country")
...
dm.append(
    DM_eu["fts"][1].filter({"Country": ["EU27"], "Variables": ["aluminium-pack"]}),
    "Years",
)
dm.rename_col("EU27", "Switzerland", "Country")
...
dm[..., "waste-collected"] = (
    1 - dm[..., "export"] - dm[..., "littered"] - dm[..., "waste-uncollected"]
)
dm[..., "recycling"] = 1.0
dm[..., "incineration"] = 0.0
dm[..., "landfill"] = 0.0
...
f = os.path.join(
    current_file_directory, "../data/datamatrix/lever_waste-management.pickle"
)
