...
def industry_energy_interface(
    ...
    dm_temp1 = dm_energy_demand_by_carr.filter(
        {"Categories1": ["lighting", "electricity-else"]}
    )
    dm_temp1.rename_col(
...
def industry_forestry_interface(
    dm_material_demand, dm_fxa_demand_wwp, write_pickle=False
):
    # get pulp and timber
