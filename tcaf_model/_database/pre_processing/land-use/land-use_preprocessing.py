...
from tcaf_model.model.common.auxiliary_functions import (
    create_years_list,
    dm_match_countries,
    filter_unreliable_country_category,
    linear_fitting,
...
def crop_yield(dm_prod_share):
    ...
    df_dict_csc = pd.read_excel(
        "dictionaries/dictionary_land-use.xlsx", sheet_name="climate-smart-crops"
    )
...
def cropland_calibration(list_countries):
    ...
    # Read excel file
    df_dict_csc = pd.read_excel(
        "dictionaries/dictionary_land-use.xlsx", sheet_name="calibration"
    )
...
def constant():
    ...
    # Read excel
    df_cp_bev = pd.read_excel("data/land-use_constants.xlsx", sheet_name="cp_ibp_bev")
