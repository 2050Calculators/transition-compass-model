"""TCAF build of the Transition Compass model."""
...
def _register_compat_aliases():
    ...
    """
    import tcaf_model.model.common.data_matrix_class  # noqa: F401

    _mappings = {
        "model": "tcaf_model.model",
        "model.common": "tcaf_model.model.common",
        "model.common.data_matrix_class": "tcaf_model.model.common.data_matrix_class",
    }
